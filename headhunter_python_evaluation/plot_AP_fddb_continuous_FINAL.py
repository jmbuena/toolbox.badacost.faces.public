...
import os
import sys
from getColorLabelFDDB_FINAL import *
...
#              'ytick.labelsize': 'x-large'}
    ...
    lff = glob.glob("detections/fddb_continuous_FINAL/*.txt")
...
#    pylab.legend(ii, ll, loc='lower right', ncol=2)
    ...
    # end JMBUENA
    savename = "FDDB_FINAL_ContROC_final.pdf"
    pylab.savefig(savename)
    os.system("pdfcrop %s" % (savename))
    savename = "FDDB_FINAL_ContROC_final.eps"
    pylab.savefig(savename)
